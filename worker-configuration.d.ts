/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2e03b58672423fb3725a85821655f221)
// Runtime types generated with workerd@1.20260804.1 2026-07-29 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	API_RATE_LIMITER: RateLimit;
	EXPENSIVE_API_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	BACKEND_ORIGIN: "https://stockbacktest.vercel.app";
	BACKTESTSTOCK_REQUIRE_EDGE_AUTH: "true";
	BACKTESTSTOCK_REQUIRE_RATE_LIMIT: "true";
	BACKTESTSTOCK_EDGE_SECRET: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/router");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BACKEND_ORIGIN" | "BACKTESTSTOCK_REQUIRE_EDGE_AUTH" | "BACKTESTSTOCK_REQUIRE_RATE_LIMIT" | "BACKTESTSTOCK_EDGE_SECRET">> {}
}
