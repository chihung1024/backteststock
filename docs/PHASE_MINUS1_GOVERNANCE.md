...
Status: proposed baseline for the Portfolio Refinery program.

Baseline main SHA: `35fe0e3f9c4ff5fc5f49b4abafeba3f5e6691a0c`.
...
`README.md`, `apps/api/README.md`, and `docs/DEPLOYMENT.md` must describe this current state and must not describe FastAPI as a future-only cutover.
...
Repository-settings enforcement is intentionally separate from source code. If automation cannot mutate those settings, this document remains the explicit gate and the setting must be applied manually before Phase 0 is approved.
